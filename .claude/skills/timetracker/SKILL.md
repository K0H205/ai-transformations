...
ユーザー承認後、[`playwright-cli`](../.claude/skills/playwright-cli/SKILL.md) Skill の **ループ入力テンプレート** を使用してスクリプトを生成・実行する。
...
- [`playwright-cli`](../.claude/skills/playwright-cli/SKILL.md) — ブラウザ自動化の共通テンプレート・リファレンス（Step 5 で使用）
